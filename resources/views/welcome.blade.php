...
<body>
    ...
    <header class="hero-zada">
        <div class="hero-text">
            ...
            <a href="{{ url('/products') }}">Shop The Look</a>
        </div>
    </header>
    ...
    <main class="section-container">
        ...
        @guest
            <div class="login-prompt">
                <h3>Jelajahi Koleksi Terbaik Kami</h3>
                <p>Daftar atau masuk untuk melihat koleksi produk lengkap, harga khusus, dan kemudahan berbelanja.</p>
                <div class="login-prompt-buttons">
                    <a href="{{ route('login') }}" class="btn-login">Log in</a>
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="btn-register">Register Sekarang</a>
                    @endif
                </div>
            </div>
        @endguest
        ...
        <div class="zada-grid">
            @forelse ($products as $product)
                ...
                @else
                    <div class="zada-card" style="cursor: pointer;" onclick="window.location.href='{{ route('login') }}'">
                        {{-- 1. KATEGORI --}}
                        <div class="category-badge">
                            {{ $product->category->name ?? 'Furniture' }}
                        </div>
