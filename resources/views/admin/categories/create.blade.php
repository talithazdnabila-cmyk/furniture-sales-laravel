...
@section('title', 'Tambah Kategori - ZADA.CO')
...
<div class="container-fluid py-4">
    ...
    <div class="header-section">
        ...
        <p class="text-muted small fw-bold" style="letter-spacing: 1px;">Define new collections for ZADA Luxe</p>
    </div>
    ...
    <div class="card card-luxury">
        <div class="card-body p-4 p-md-5">
            ...
            {{-- ALERT ERROR --}}
            @if ($errors->any())
                <div class="alert alert-zada mb-4 shadow-sm">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-12">
                        ...
                        <small class="text-muted mt-2 d-block" style="font-size: 11px;">
                            Give your category a unique name that represents the product collection.
                        </small>
                    </div>
